  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="flex flex-col sm:flex-row gap-5 w-full max-w-2xl">
        ...
        {/* AKUN BISNIS */}
        <div className="flex-1 bg-white rounded-2xl border border-slate-200 shadow-lg shadow-slate-100/80 p-8 flex flex-col items-center text-center gap-5 hover:border-slate-800 hover:shadow-slate-300 transition-all duration-200">
          ...
          <Link href="/register/business"
            className="w-full py-2.5 rounded-lg bg-slate-800 hover:bg-slate-900 text-white font-bold text-sm text-center shadow-md shadow-slate-300 transition-all">
